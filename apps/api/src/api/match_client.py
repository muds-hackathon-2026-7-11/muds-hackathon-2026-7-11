...
_BULK_SYSTEM_PROMPT = (
    ...
    "採点の指針:\n"
    "- 0〜100の全体を使い、極端な0/100に偏らせない。完全一致でなくても、"
    "隣接分野・応用可能な手法やスキル・関心の方向性・育成方針の親和性など"
    "間接的な関連があれば中間的な点(目安30〜60)を与える。\n"
    "- 0点はその観点で明確に無関係・相反する場合のみ。"
    "100点は明確に強く一致する場合のみ。\n"
    "- 資料から読み取れない点を推測で高評価しないが、"
    "無関係と即断もしない。学部・分野の一般常識の範囲で妥当に評価する。\n"
    "必ず日本語で、指定されたJSON形式のみを返してください。"
)
